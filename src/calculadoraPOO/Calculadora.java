...
public class Calculadora implements Visual{
	...
	public void Divisao() {
		if(this.getN1() > this.getN2()) {
			double n3 = this.getN1() / this.getN2();
			System.out.println("1�: A divisao de "+this.getN1()+" por "+this.getN2()+" � de "+n3);
		}else if(this.getN2() > this.getN1()) {
			double n3 = this.getN2() / this.getN1();
			System.out.println("2�: A divisao de "+this.getN2()+" por "+this.getN1()+" � de "+n3);
		}else {
			double n3 = this.getN2() / this.getN1();
			System.out.println("3�: A divisao de "+this.getN2()+" por "+this.getN1()+" � de "+n3);
		}
	}
